...
object ButtonTheme {
  ...
  val buttonColors: ButtonColors = ButtonColors(
    ...
    white = ButtonStyleColors(
      base = "focus:ring-gray-500",
      fill = "bg-white hover:bg-gray-200 text-gray-900 hover:text-black",
      outline = "text-gray-200 border-gray-300 hover:text-white hover:border-white",
  ...
  val button: Button = Button(
    ...
    disabled = BaseAndCustom(
      base = "disabled:opacity-75 disabled:text-opacity-75 disabled:cursor-not-allowed"
    ),
